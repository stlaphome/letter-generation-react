  ...
  return (
    <div style={{ width: "40%", height: "100%" }}>
      <div style={{ textAlign: "center" }}>
        <div>{"Connecting You to SHFL Server ....."}</div>
        <div>{"Validating Credentials ....."}</div>
        <div>
          {
            "Redirecting to Letter Generation or Login Page based on Credentials ....."
          }
        </div>
      </div>
      <svg
        ...
        <g id="Layer_x0020_1_client">
          ...
          <g id="_1707362028240_client">
            <g className="right_boy">
              ...
              <polygon
                className={"client_fil2"}
                points="152.03,56.58 148.92,74.09 166.99,51.15 "
              />
              <path
                className={"client_fil13"}
